...
trait CourseEmailTemplate
{
    ...
    public static function courseStatusChangeMail($enroll_details)
    {
        return [
            'subject' => __('Course Enrollment Status Update'),
            'message' => __('Your enrollment status for course ID: ') . $enroll_details->course_id . __(' has been updated to ') . $enroll_details->status
        ];
