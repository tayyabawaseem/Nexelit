...
class ProductsController extends Controller
{
    ...
    public function store_product(Request $request)
    {
        ...
        if ($request->hasFile('downloadable_file')) {
            ...
            if (in_array($file_extenstion,['doc','docx','jpg','jpeg','png','webp','mp3','mp4','pdf','txt','zip'])) {
                ...
                // file scan start
                $uploaded_file = $request->downloadable_file;
                ...
                if (in_array($file_extension, ['jpg', 'jpeg', 'png', 'gif', 'webp'])) {
                    ...
                    $processed_image->save('assets/uploads/downloadable/' . $file_db);
                }else{
