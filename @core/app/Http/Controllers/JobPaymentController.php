...
//        }
        ...
        if (!empty($jobs_details->application_fee_status) && $jobs_details->application_fee > 0){
            ...
            elseif ($request->selected_payment_gateway === 'senangpay') {
                $params = $this->common_charge_customer_data($job_applicant_details,$jobs_details,route('frontend.job.senangpay.ipn'));
            ...
            elseif ($request->selected_payment_gateway === 'iyzipay') {
                $params = $this->common_charge_customer_data($job_applicant_details,$jobs_details,route('frontend.job.iyzipay.ipn'));
            ...
            elseif ($request->selected_payment_gateway === 'awdpay') {
                $params = $this->common_charge_customer_data($job_applicant_details,$jobs_details,route('frontend.job.awdpay.ipn'));
