...
class EventPaymentLogsController extends Controller
{
    ...
    public function booking_payment_form(Request $request){
        ...
        elseif ($request->selected_payment_gateway === 'senangpay') {
            $params = $this->common_charge_customer_data($event_details,$event_payment_details,route('frontend.event.senangpay.ipn'));
        ...
        elseif ($request->selected_payment_gateway === 'iyzipay') {
            $params = $this->common_charge_customer_data($event_details,$event_payment_details,route('frontend.event.iyzipay.ipn'));
        ...
        elseif ($request->selected_payment_gateway === 'awdpay') {
            $params = $this->common_charge_customer_data($event_details,$event_payment_details,route('frontend.event.awdpay.ipn'));
