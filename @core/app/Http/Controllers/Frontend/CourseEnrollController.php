...
class CourseEnrollController extends Controller
{
    ...
    public function enroll_now(Request $request)
    {
        ...
        elseif ($request->selected_payment_gateway === 'senangpay') {
            $params = $this->common_charge_customer_data($new_enroll,route('frontend.course.senangpay.ipn'));
        ...
        elseif ($request->selected_payment_gateway === 'iyzipay') {
            $params = $this->common_charge_customer_data($new_enroll,route('frontend.course.iyzipay.ipn'));
        ...
        elseif ($request->selected_payment_gateway === 'awdpay') {
            $params = $this->common_charge_customer_data($new_enroll,route('frontend.course.awdpay.ipn'));
