...
class ProductOrderController extends Controller
{
    ...
    public function product_checkout(Request $request){
        ...
        elseif ($request->selected_payment_gateway === 'senangpay') {
            $params = $this->common_charge_customer_data($order_details,route('frontend.product.senangpay.ipn'));
        ...
        elseif ($request->selected_payment_gateway === 'iyzipay') {
            $params = $this->common_charge_customer_data($order_details,route('frontend.product.iyzipay.ipn'));
        ...
        elseif ($request->selected_payment_gateway === 'awdpay') {
            $params = $this->common_charge_customer_data($order_details,route('frontend.product.awdpay.ipn'));
