...
//            ]));
        ...
        elseif ($request->selected_payment_gateway === 'senangpay') {
            $params = $this->common_charge_customer_data($donation_payment_details,route('frontend.donation.senangpay.ipn'));
        ...
        elseif ($request->selected_payment_gateway === 'iyzipay') {
            $params = $this->common_charge_customer_data($donation_payment_details,route('frontend.donation.iyzipay.ipn'));
        ...
        elseif ($request->selected_payment_gateway === 'awdpay') {
            $params = $this->common_charge_customer_data($donation_payment_details,route('frontend.donation.awdpay.ipn'));
