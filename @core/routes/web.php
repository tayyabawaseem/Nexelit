...
Route::group(['middleware' => ['setlang:frontend', 'globalVariable', 'maintains_mode']], function () {
    ...
    Route::group(['namespace' => 'Frontend','moduleCheck:course_module_status'],function (){
        ...
        Route::get('/course-senangpay-ipn','CourseEnrollController@senangpay_ipn')->name('frontend.course.senangpay.ipn');
        Route::post('/course-iyzipay-ipn','CourseEnrollController@iyzipay_ipn')->name('frontend.course.iyzipay.ipn');
        Route::get('/course-awdpay-ipn','CourseEnrollController@awdpay_ipn')->name('frontend.course.awdpay.ipn');
    });
...
Route::group(['middleware' => ['setlang:frontend', 'globalVariable', 'maintains_mode','moduleCheck:appointment_module_status']], function () {
    ...
    Route::get('/appointment-senangpay-ipn','Frontend\AppointmentBookingController@senangpay_ipn')->name('frontend.appointment.senangpay.ipn');
    Route::post('/appointment-iyzipay-ipn','Frontend\AppointmentBookingController@iyzipay_ipn')->name('frontend.appointment.iyzipay.ipn');
    Route::get('/appointment-awdpay-ipn','Frontend\AppointmentBookingController@awdpay_ipn')->name('frontend.appointment.awdpay.ipn');
...
Route::group(['middleware' => ['setlang:frontend', 'globalVariable', 'maintains_mode','moduleCheck:donations_module_status']], function () {
    ...
    Route::get('/donation-senangpay-ipn','DonationLogController@senangpay_ipn')->name('frontend.donation.senangpay.ipn');
    Route::post('/donation-iyzipay-ipn','DonationLogController@iyzipay_ipn')->name('frontend.donation.iyzipay.ipn');
    Route::get('/donation-awdpay-ipn','DonationLogController@awdpay_ipn')->name('frontend.donation.awdpay.ipn');
});
...
Route::group(['middleware' => ['setlang:frontend', 'globalVariable', 'maintains_mode','moduleCheck:product_module_status']], function () {
    ...
    //coupon remove
    Route::post( $product_page_slug.'-remove-coupon', 'ProductCartController@product_coupon_remove')->name('frontend.product.coupon.remove');
    ...
    Route::get('/product-senangpay-ipn','ProductOrderController@senangpay_ipn')->name('frontend.product.senangpay.ipn');
    Route::post('/product-iyzipay-ipn','ProductOrderController@iyzipay_ipn')->name('frontend.product.iyzipay.ipn');
    Route::get('/product-awdpay-ipn','ProductOrderController@awdpay_ipn')->name('frontend.product.awdpay.ipn');
...
Route::group(['middleware' => ['setlang:frontend', 'globalVariable', 'maintains_mode', 'moduleCheck:events_module_status']], function () {
    ...
    Route::post('/event-iyzipay-ipn','EventPaymentLogsController@iyzipay_ipn')->name('frontend.event.iyzipay.ipn');
...
Route::group(['middleware' => ['setlang:frontend', 'globalVariable', 'maintains_mode', 'moduleCheck:job_module_status']], function () {
    ...
    Route::post('/job-iyzipay-ipn','JobPaymentController@iyzipay_ipn')->name('frontend.job.iyzipay.ipn');
...
Route::group(['middleware' => ['setlang:frontend', 'globalVariable', 'maintains_mode', 'HtmlMinifier']], function () {
    ...
    Route::get('/price-plan-senangpay-ipn','PaymentLogController@senangpay_ipn')->name('frontend.price.plan.senangpay.ipn');
    Route::post('/price-plan-iyzipay-ipn','PaymentLogController@iyzipay_ipn')->name('frontend.price.plan.iyzipay.ipn');
    Route::get('/price-plan-awdpay-ipn','PaymentLogController@awdpay_ipn')->name('frontend.price.plan.awdpay.ipn');
