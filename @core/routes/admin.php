...
use App\Http\Controllers\CustomFontImportController;
       ...
       * Enrollment
       --------------------------*/
        Route::group(['prefix' => 'enroll'],function (){
            ...
            Route::post('/enroll-status-change', [\App\Http\Controllers\CourseEnrollController::class, 'enroll_status_change'])->name('admin.course.enroll.status.change');
        });
...
==============================================*/
    ...
    Route::prefix('general-settings')->middleware(['adminPermissionCheck:General Settings'])->group(function () {
      ...
      ----------------------------------------------------*/
        ...
        Route::post('typography/custom/font/file', [CustomFontImportController::class, 'add_custom_font'])->name('admin.custom.font.add');
        Route::post('/typography/change-status/{id}', [CustomFontImportController::class, 'change_status_custom_font'])->name('admin.custom.font.status');
        Route::post('/typography/custom-font-heading/change-status/{id}', [CustomFontImportController::class, 'change_status_custom_font_heading'])->name('admin.custom.heading.font.status');
        Route::post('typography/custom-font/delete/{id}', [CustomFontImportController::class, 'deleteFontFile'])->name('admin.custom.delete.font.file');
