                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="product-info-wrap">
                                                                ...
                                                                <ul class="product-variant-list">
                                                                    <li>
                                                                        ...
                                                                        @if (isset($prices[$index]) && !empty($prices[$index]))
                                                                         @php 
                                                                         $product_variant_price += $prices[$index];
                                                ...
                                                <span class="pdetails"><strong>{{__('Price :')}}</strong> {{amount_with_currency_symbol($product_info->sale_price + $product_variant_price)}}</span>
                                                ...
                                                @if(get_static_option('product_tax_type') === 'individual' && is_tax_enable())
                                                    @php
                                                        ...
                                                        $tax_amount = ($product_info->sale_price + $product_variant_price) / 100 * $product_info->tax_percentage;
                                                    @endphp
                                                    <span class="pdetails" style="color: red"><strong>{{__('Tax')}} {{'('.$percentage.'%) :'}}</strong> +{{amount_with_currency_symbol($tax_amount)}}</span>
                                                @endif
                                                <span class="pdetails"><strong>{{__('Subtotal :')}}</strong> {{amount_with_currency_symbol(($product_info->sale_price + $product_variant_price + $tax_amount) * $item['quantity'] )}}</span>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
