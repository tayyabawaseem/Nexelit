                        ...
                        <div class="left-content">
                            <ul class="social-icons">
                                @foreach($all_social_item as $data)
                                    ...
                                    @endphp
                                    <li>
                                        <a href="{{ $data->url }}" rel="canonical" aria-label="Visit our {{ $platform }} page">
                                            <i class="{{ $data->icon }}"></i>
                                        </a>
                                    </li>
                                @endforeach
                            ...
                            <ul>
                                @if(auth()->check())
                                    ...
                                    <li class="login-register">
                                        ...
                                        <a href="{{ route('user.logout') }}" onclick="event.preventDefault();  document.getElementById('userlogout-form').submit();">
                                            {{ __('Logout') }}
                                        </a>
                                        ...
                                        <br>
                                        @if(!empty(get_static_option('navbar_username_show_hide')))
