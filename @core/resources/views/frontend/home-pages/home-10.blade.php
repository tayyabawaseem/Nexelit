                                ...
                                <div class="appointment-single-item lawyyer-home">
                                    ...
                                    >
                                        @if ($data->category && $data->category->id)
                                            <div class="cat">
                                                <a href="{{route('frontend.appointment.category',['id' => $data->category->id ?? null,'any' => Str::slug($data->category->lang_front->title ?? __("Uncategorized"))])}}">{{$data->category->lang_front->title ?? __("Uncategorized")}}</a>
                                            </div>
                                        @endif
                                    </div>
                                    <div class="content">
