                ...
                @if(!empty($product->variant) && count(json_decode($product->variant,true)) > 0)
                    <a href="{{route('frontend.products.single',$product->slug)}}"
                       ...
                       data-product_quantity="1">
                        ...
                        {{get_static_option('product_view_option_button_'.$user_select_lang_slug.'_text',__('View Options'))}}
                    </a>
                @elseif($product->is_downloadable === 'on' && $product->direct_download === 1)
                    <a href="{{route('frontend.products.single',$product->slug)}}"
                       ...
                       data-product_quantity="1">
                        ...
                        {{get_static_option('product_download_now_button_'.$user_select_lang_slug.'_text')}}
                    </a>
                @else
