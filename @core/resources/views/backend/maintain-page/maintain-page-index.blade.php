                        ...
                        <form action="{{route('admin.maintains.page.settings')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="tab-content margin-top-30" id="nav-tabContent">
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">{{__('allowed image format: jpg,jpeg,png,webp. Recommended image size 300x100')}}</small>
                                </div>
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">{{__('allowed image format: jpg,jpeg,png,webp. Recommended image size 1920x1000')}}</small>
                                </div>
                            </div>
                            <div class="form-group">
