                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.navbar.settings')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="navbar_username_show_hide"><strong>{{__('Navbar Username Show/Hide')}}</strong></label>
                                <label class="switch">
                                    <input type="checkbox" name="navbar_username_show_hide"  @if(!empty(get_static_option('navbar_username_show_hide'))) checked @endif >
                                    <span class="slider"></span>
                                </label>
                            </div>
