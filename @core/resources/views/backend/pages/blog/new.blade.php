                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.blog.new')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <input type="hidden" id="old_language" value="{{ old('lang') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="lang" id="language" class="form-control">
                                            ...
                                            @foreach($all_languages as $lang)
                                                <option value="{{ $lang->slug }}" {{ old('lang') == $lang->slug ? 'selected' : '' }}>
                                                    {{ $lang->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="excerpt" id="excerpt"
                                                  ...
                                                  cols="30" rows="10">{{ old('excerpt') }}</textarea>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="breaking_news" {{ old('breaking_news') ? 'checked' : '' }}>
               ...
               $.ajax({
                  ...
                  data: {
                   ...
                   success:function (data) {
                       ...
                       // 👇 After appending categories, select the old one if exists
