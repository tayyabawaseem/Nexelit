                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group custom_font_title_button">
                            ...
                            <label class="switch">
                                <input type="checkbox" name="custom_font" @if($custom_font >= 1) checked
                                       @else  @endif id="custom_font">
                        ...
                        <div class="custom_font_upload">
                            ...
                            <form action="{{ route('admin.custom.font.add') }}" method="POST"
                                                ...
                                                @foreach($all_fonts as $data)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @endif
                                                            @if($data->status==0)
                                                                <span><x-custom-body-font
                                                                            :url="route('admin.custom.font.status',$data->id)"/></span>
                                                            @endif
                                                        ...
                                                        <td>
                                                            ...
                                                            @endif
                                                            @if($data->status==0)
                                                                <span><x-custom-heading-font
                                                                            :url="route('admin.custom.heading.font.status',$data->id)"/></span>
                                                            @endif
                                                        ...
                                                        <td>
                                                            ...
                                                            @if($data->status == 0)
                                                                ...
                                                                <x-delete-popover
                                                                        :url="route('admin.custom.delete.font.file',$data->id)"/>
                        ...
                        <div class="google_font_hide_and_show">
                            ...
                            <form action="{{route('admin.general.typography.settings')}}" method="POST"
                                    ...
                                    <select class="form-control nice-select wide" name="body_font_family"
                                        ...
                                        @foreach($google_fonts as $font_family => $font_variant)
                                            <option value="{{$font_family}}"
                                                    @if($font_family == get_static_option('body_font_family')) selected @endif>{{$font_family}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group margin-top-50">
                                    ...
                                    @endphp
                                    <select class="form-control nice-select wide" multiple id="body_font_variant"
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" name="heading_font"
                                               @if(!empty(get_static_option('heading_font'))) checked
                                               @endif id="heading_font">
                                        <span class="slider"></span>
                                    </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control nice-select wide" name="heading_font_family"
                                        ...
                                        @foreach($google_fonts as $font_family => $font_variant)
                                            <option value="{{$font_family}}"
                                                    @if($font_family == get_static_option('heading_font_family')) selected @endif>{{$font_family}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group margin-top-50">
                                    ...
                                    @php
                                        ...
                                        $get_font_family_variants = property_exists($google_fonts,$font_family_selected) ? (array) $google_fonts->$font_family_selected : ['variants' => array('regular')];
                                    @endphp
                                    <select class="form-control nice-select wide" multiple name="heading_font_variant[]"
